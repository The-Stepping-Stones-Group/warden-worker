...
-- Organizations table for shared vaults
...
-- Collections table for organization cipher grouping
...
-- Per-user collection permissions.
...
-- Cipher-to-collection assignments.
